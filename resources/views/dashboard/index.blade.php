<div class="pb-10">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <!-- Ocupación (Tema Azul) -->
        <div class="relative bg-white rounded-2xl p-6 shadow-sm border border-slate-200/80 overflow-hidden group hover:-translate-y-1 hover:shadow-md transition-all duration-300">
        ...
        <div class="relative bg-white rounded-2xl p-6 shadow-sm border border-slate-200/80 overflow-hidden group hover:-translate-y-1 hover:shadow-md transition-all duration-300">
            ...
            <div>
                ...
                <div class="mt-2 flex items-baseline gap-2">
                    <span class="text-4xl font-extrabold text-slate-900 tracking-tight">{{ $tareasPendientes->count() }}</span>
                </div>
                <p class="mt-2 text-sm text-slate-500 font-medium">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
        ...
        <!-- Próximas Llegadas -->
        <div class="bg-white rounded-2xl border border-slate-200/80 shadow-sm flex flex-col h-full">
        ...
        <div class="bg-white rounded-2xl border border-slate-200/80 shadow-sm flex flex-col h-full">
            <div class="px-5 py-4 border-b border-slate-100 flex justify-between items-center bg-slate-50/50 rounded-t-xl">
                ...
                <span class="bg-amber-100 text-amber-700 text-xs font-bold px-2.5 py-1 rounded-full">{{ $tareasPendientes->count() }} Tareas</span>
            </div>
            <div class="flex-grow flex flex-col items-center justify-center py-14 px-6 text-center">
